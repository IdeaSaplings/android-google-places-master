...
public class GooglePlaces {
	 ...
	 * @throws IOException
	 */
	public Result getNearbyPlaces(List<String> types, String keyword,
			int radius, double lat, double lon) throws IOException {
	 ...
	 */
	public Result getNearbyPlaces(List<String> types, String keyword,
			String rankby, double lat, double lon) throws IOException {
	 ...
	 * @throws IOException
	 */
	public Result getNearbyPlaces(List<String> types, int radius, double lat,
	 ...
	 * @throws IOException
	 */
	public Result getNearbyPlaces(String type, String keyword, int radius,
	 ...
	 * @throws IOException
	 */
	public Result getNearbyPlaces(int radius, double lat, double lon)
			throws IOException {
		return getPlaces(new NearbySearchQuery(mApiKey, lat, lon));
	}
	 ...
	 * @throws IOException
	 */
	public Result getTextPlaces(String searchText, boolean sensor)
			throws IOException {
	 ...
	 */
	public Result getTextPlaces(List<String> types, String searchText,
			int radius, double lat, double lon) throws IOException {
	...
	public Result getPlaceDetails(String placeid) throws IOException {
		return getPlaces(new DetailsQuery(this.mApiKey, placeid),
	...
	public Result getPlacesPhoto(String photoreference) throws IOException {
		return sendRequest(new PhotoQuery(mApiKey, photoreference),
				PhotoResult.class);
	 ...
	 * @throws IOException
	 */
	public Result getPlacesPhoto(String photoreference, int maxWidth,
	 ...
	 * @throws IOException
	 */
	public Result getPlaces(Query query, Class<? extends Result> resultClass)
			throws IOException {
	 ...
	 * @throws JSONException
	 */
	private Result sendRequest(Query query, Class<? extends Result> resultClass)
			throws IOException {
